...
const RestaurantScreen = ({ navigation, route }) => {
  ...
  const formatBusinessHours = (businessHours) => {
    ...
    return `Abierto hoy: ${todayHours.open || '00:00'} - ${todayHours.close || '23:59'}`;
  };
    ...
    <View style={styles.restaurantInfo}>
      <View style={styles.restaurantHeader}>
        <View style={styles.restaurantTitleContainer}>
          ...
          <View style={styles.statusContainer}>
            <View style={[
              styles.statusDot, 
              { backgroundColor: isRestaurantOpen() ? theme.success : theme.danger }
            ]} />
            <Text style={[
              styles.statusText,
      ...
      <View style={styles.restaurantMeta}>
        <View style={styles.metaItem}>
          ...
          <Text style={styles.metaText}>{formatBusinessHours(restaurant.business_hours)}</Text>
        </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bannerContainer}>
        <Image
          source={{ 
            uri: restaurant.banner || `https://placehold.co/800x300?text=${encodeURIComponent(restaurant.name)}`
          }}
